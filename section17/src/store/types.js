...
// Mutations
export const MUTATE_INCREMENT_COUNTER = 'counter/MUTATE_COUNTER_INCREMENT';
export const MUTATE_DECREMENT_COUNTER = 'counter/MUTATE_COUNTER_DECREMENT';
export const MUTATE_UPDATE_VALUE = 'counter/MUTATE_UPDATE_VALUE';
